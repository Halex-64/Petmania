...
const criaNovaLinha = (produto, preco, descricao) => {
   ...
   const conteudo = `
      ...
      <td>
         <ul class="tabela__botoes-controle">
            <li><a href="../telas/edita_cliente.html?id=${descricao}" class="botao-simples botao-simples--editar">Editar</a></li>
...
.then(data => {
   ...
   data.forEach(element => {
      tabela.appendChild(criaNovaLinha(element.produto, element.preco, element.descricao))
   })
})
